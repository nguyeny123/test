...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.Order", b =>
                {
                    ...
                    b.OwnsOne("ECommerce.Data.Entities.Orders.Address", "DeliveryAddress", b1 =>
                        {
                            ...
                            b1.HasOne("ECommerce.Data.Entities.Orders.Order")
                                .WithOne("DeliveryAddress")
                                .HasForeignKey("ECommerce.Data.Entities.Orders.Address", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("ECommerce.Data.Entities.Orders.Order")
                        .WithMany("Items")
